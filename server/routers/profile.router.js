...
router.get("/:id/text/completed", isAuth, checkAccessRights, profileController.getCompletedTexts);
router.get("/:id/favorites", isAuth, checkAccessRights, profileController.getFavorites);
